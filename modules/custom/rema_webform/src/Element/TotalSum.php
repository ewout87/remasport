 ...
 */
class TotalSum extends FormElement {
  ...
  public function getInfo() {
    ...
    return [
      ...
      '#size' => 60,
      '#process' => [
        [$class, 'processTotalSum'],
        [$class, 'processAjaxForm'],
      ],
      '#element_validate' => [
        [$class, 'validateTotalSum'],
      ],
      '#pre_render' => [
        [$class, 'preRenderTotalSum'],
      ],
   ...
   */
  public static function processTotalSum(&$element, FormStateInterface $form_state, &$complete_form) {
  ...
  public static function preRenderTotalSum(array $element) {
    ...
    $element['#attached']['drupalSettings']['start_value'] = $element['#start'];
